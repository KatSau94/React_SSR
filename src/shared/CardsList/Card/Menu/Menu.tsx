...
export function Menu() {
  const button: JSX.Element = 
    ...
    const list = [
    {text: "Комментарии", img: <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>, onlyDesktop: true
    },
    {text: "Поделиться", img: <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {text: "Скрыть", img: <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {text: "Сохранить", img: <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {text: "Пожаловаться", img: <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
